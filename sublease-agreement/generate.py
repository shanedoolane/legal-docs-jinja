...
template = env.get_template('sublease-agreement.md')
...
# convert the IOS 8601 strings from the datetime object into datetime natives
data['lease_start_datetime_utc'] = datetime.fromisoformat(data['lease_start_datetime_utc'].replace("Z", "+00:00"))
data['lease_end_datetime_utc'] = datetime.fromisoformat(data['lease_end_datetime_utc'].replace("Z", "+00:00"))
